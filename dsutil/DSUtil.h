...
extern BOOL IsRenderer(IBaseFilter* aFilter);
...
extern GUID GUIDFromCString(LPCTSTR str);
extern HRESULT GUIDFromCString(LPCTSTR str, GUID& guid);
...
#define QI(i) (riid == __uuidof(i)) ? GetInterface(static_cast<i*>(this), ppv) :
#define QI2(i) (riid == IID_##i) ? GetInterface(static_cast<i*>(this), ppv) :
